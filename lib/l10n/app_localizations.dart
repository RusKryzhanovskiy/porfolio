...
abstract class AppLocalizations {
  ...
  /// No description provided for @assetAapl.
  ///
  /// In en, this message translates to:
  /// **'AAPL'**
  String get assetAapl;

  /// Apple stock amount display
  ///
  /// In en, this message translates to:
  /// **'Amount: {amount}'**
  String assetAmountAapl(int amount);

  /// No description provided for @assetDetailsTitle.
  ///
  /// In en, this message translates to:
  /// **'Asset Details'**
  String get assetDetailsTitle;

  /// No description provided for @assetDetailsDummy.
  ///
  /// In en, this message translates to:
  /// **'Dummy asset details'**
  String get assetDetailsDummy;
}
